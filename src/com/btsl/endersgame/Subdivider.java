...
public class Subdivider {
	...
	public static void Subdivide(Model model) {
		if (faces.size() == 0)
	        GenerateAdjacencyInformation(model.GetVertices(),
	        							 model.GetNormals(),
	        							 model.GetTex(),
	        							 model.GetFaces());
	...
	private static void ExportToModel(Model model) {
		ArrayList<Float> model_vertices = model.GetVertices();
	    ArrayList<Integer> model_faces = model.GetFaces();
